...
<head>
	...
	<link href="<?php echo $dash->get_dir_url(); ?>/css/bootstrap.min.css" rel="stylesheet">
	<link href="<?php echo $dash->get_dir_url(); ?>/css/wildfire.css" rel="stylesheet">
	<link href="<?php echo $dash->get_dir_url(); ?>/plugins/fontawesome/css/all.min.css" rel="stylesheet">
	<link href="<?php echo $dash->get_dir_url(); ?>/css/custom.css" rel="stylesheet">
  	<link href="<?php echo $dash->get_dir_url(); ?>/css/user.css" rel="stylesheet">
</head>
